...
var $author$project$Sommen$DoNothing = {$: 'DoNothing'};
...
var $author$project$Expression$Subtraction = {$: 'Subtraction'};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Expression$decodeOperator = function () {
	var operatorSelector = function (op) {
		switch (op) {
			case '+':
				return $elm$json$Json$Decode$succeed($author$project$Expression$Addition);
			case '-':
				return $elm$json$Json$Decode$succeed($author$project$Expression$Subtraction);
			case '⨉':
				return $elm$json$Json$Decode$succeed($author$project$Expression$Multiplication);
			default:
				return $elm$json$Json$Decode$fail('unknown operator \"' + (op + '\"'));
		}
	};
	return A2($elm$json$Json$Decode$andThen, operatorSelector, $elm$json$Json$Decode$string);
}();
var $author$project$Expression$Between = F2(
	function (a, b) {
...
var $author$project$Expression$decodeTag = A2($elm$json$Json$Decode$field, 'tag', $elm$json$Json$Decode$string);
var $author$project$Expression$decodeType = A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string);
var $author$project$Expression$guardedDecoder = F3(
	function (target, decoder, candidate) {
		return _Utils_eq(target, candidate) ? decoder : $elm$json$Json$Decode$fail('expected target \"' + (target + ('\" but found \"' + (candidate + '\"'))));
	});
var $author$project$Expression$decodeRange = function () {
	var decodePositiveRange = A2(
		$elm$json$Json$Decode$map,
	...
	var decodeBetweenRange = A3(
		...
		A2($elm$json$Json$Decode$field, 'minimum', $elm$json$Json$Decode$int),
		A2($elm$json$Json$Decode$field, 'maximum', $elm$json$Json$Decode$int));
	var decodeRangeType = function (aType) {
		switch (aType) {
			...
			case 'Between':
				return decodeBetweenRange;
			default:
				return $elm$json$Json$Decode$fail('unrecognized Value type \"' + (aType + '\"'));
		}
	};
	var typeSelector = A2($elm$json$Json$Decode$andThen, decodeRangeType, $author$project$Expression$decodeType);
	return A2(
...
var $author$project$Quiz$decodeDescription = function () {
	var decodeOperators = A3(
		$elm$json$Json$Decode$map2,
		$elm$core$Tuple$pair,
		A2($elm$json$Json$Decode$field, 'main', $author$project$Expression$decodeOperator),
		A2(
			$elm$json$Json$Decode$field,
			'rest',
...
var $author$project$Quiz$Quiz = function (a) {
	return {$: 'Quiz', a: a};
};
...
var $author$project$Expression$operator = $elm$random$Random$uniform;
var $author$project$Quiz$uncurry = F2(
	function (f, _v0) {
		var a = _v0.a;
		var b = _v0.b;
		return A2(f, a, b);
...
var $author$project$Question$ExpressionReceived = function (a) {
	return {$: 'ExpressionReceived', a: a};
};
var $author$project$Expression$Expression = F3(
	function (a, b, c) {
		return {$: 'Expression', a: a, b: b, c: c};
	});
...
var $author$project$Expression$expression = $elm$random$Random$map3($author$project$Expression$Expression);
...
var $author$project$Quiz$init = function (description) {
	...
	var cmd = _v0.b;
	return _Utils_Tuple2(
		$author$project$Quiz$Quiz(
			{
				configuration: configuration,
				currentQuestion: question,
				nextQuestions: A2($elm$core$List$repeat, description.numberOfQuestions - 1, $elm$core$Maybe$Nothing),
				previousQuestions: _List_Nil
			}),
...
var $author$project$Sommen$queryToDict = function (input) {
	var splitAtIndex = F2(
		function (word, n) {
			return _Utils_Tuple2(
				A2($elm$core$String$left, n, word),
				A2($elm$core$String$dropLeft, n + 1, word));
		});
	var toPair = function (query) {
		return A2(
			$elm$core$Maybe$map,
			splitAtIndex(query),
			$elm$core$List$head(
				A2($elm$core$String$indices, '=', query)));
	};
	var fill = F2(
		function (query, dict) {
			return A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$Maybe$andThen,
								$elm$core$Dict$get('quiz'),
								A2($elm$core$Maybe$map, $author$project$Sommen$queryToDict, url.query)))))));
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Sommen$subscriptions = function (_v0) {
...
var $author$project$Quiz$advance = F2(
		...
		return _Utils_update(
			data,
			{
				...
				nextQuestions: A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
					$elm$core$List$tail(data.nextQuestions)),
				previousQuestions: A2($elm$core$List$cons, data.currentQuestion, data.previousQuestions)
			});
	});
var $author$project$Quiz$next = function (model) {
	var data = model.a;
	var _v0 = $elm$core$List$head(data.nextQuestions);
	if (_v0.$ === 'Just') {
		if (_v0.a.$ === 'Nothing') {
			var _v1 = _v0.a;
			...
			return _Utils_Tuple2(
				$author$project$Quiz$Quiz(
					A2($author$project$Quiz$advance, question, data)),
				A2($elm$core$Platform$Cmd$map, $author$project$Quiz$QuestionMessage, cmd));
		} else {
			var question = _v0.a.a;
			return _Utils_Tuple2(
				$author$project$Quiz$Quiz(
					A2($author$project$Quiz$advance, question, data)),
				$elm$core$Platform$Cmd$none);
...
var $author$project$Quiz$recede = F2(
	function (question, data) {
		return _Utils_update(
			data,
			{
				...
				nextQuestions: A2(
					$elm$core$List$cons,
					$elm$core$Maybe$Just(data.currentQuestion),
					data.nextQuestions),
				previousQuestions: A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
					$elm$core$List$tail(data.previousQuestions))
			});
	});
var $author$project$Quiz$previous = function (model) {
	var data = model.a;
	var _v0 = $elm$core$List$head(data.previousQuestions);
	if (_v0.$ === 'Just') {
		var question = _v0.a;
		return $author$project$Quiz$Quiz(
			A2($author$project$Quiz$recede, question, data));
	} else {
		return model;
	}
};
var $author$project$Question$Question = function (a) {
	return {$: 'Question', a: a};
};
var $author$project$Expression$lookup = function (op) {
	switch (op.$) {
		case 'Addition':
...
var $author$project$Expression$eval = function (_v0) {
	var left = _v0.a;
	var op = _v0.b;
	var right = _v0.c;
	return A3($author$project$Expression$lookup, op, left, right);
};
var $author$project$Question$Correct = {$: 'Correct'};
var $author$project$Question$Incorrect = {$: 'Incorrect'};
var $author$project$Question$toStatus = function (correct) {
	return correct ? $author$project$Question$Correct : $author$project$Question$Incorrect;
};
var $author$project$Question$check = function (model) {
	if (model.$ === 'CreatingQuestion') {
		return $author$project$Question$CreatingQuestion;
	} else {
		var data = model.a;
		var _v1 = _Utils_Tuple2(data.status, data.answer);
		if ((_v1.a.$ === 'UnChecked') && (_v1.b.$ === 'Just')) {
			var _v2 = _v1.a;
			var n = _v1.b.a;
			var aStatus = $author$project$Question$toStatus(
				_Utils_eq(
					n,
					$author$project$Expression$eval(data.expression)));
			return $author$project$Question$Question(
				_Utils_update(
					data,
					{status: aStatus}));
		} else {
			return $author$project$Question$Question(data);
		}
	}
};
var $author$project$Question$UnChecked = {$: 'UnChecked'};
var $author$project$Question$create = function (expr) {
	return {answer: $elm$core$Maybe$Nothing, answerInput: '', expression: expr, status: $author$project$Question$UnChecked};
};
var $author$project$Question$updateData = F2(
		...
		if (model.$ === 'CreatingQuestion') {
			...
			return $author$project$Question$Question(
				_Utils_update(
					data,
					{
						answer: $elm$core$String$toInt(input),
						answerInput: input
					}));
		}
	});
var $author$project$Question$update = F2(
	function (message, model) {
		switch (message.$) {
			case 'ExpressionReceived':
				var e = message.a;
				return _Utils_Tuple2(
					$author$project$Question$Question(
						$author$project$Question$create(e)),
					$elm$core$Platform$Cmd$none);
			case 'InputChanged':
				var input = message.a;
				return _Utils_Tuple2(
					A2($author$project$Question$updateData, input, model),
					$elm$core$Platform$Cmd$none);
			case 'Checked':
				return _Utils_Tuple2(
					$author$project$Question$check(model),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Quiz$update = F2(
	function (message, model) {
		var data = model.a;
		switch (message.$) {
			case 'QuestionMessage':
				var msg = message.a;
				var _v1 = A2($author$project$Question$update, msg, data.currentQuestion);
				var question = _v1.a;
				var cmd = _v1.b;
				return _Utils_Tuple2(
					$author$project$Quiz$Quiz(
					...
					A2($elm$core$Platform$Cmd$map, $author$project$Quiz$QuestionMessage, cmd));
			case 'Next':
				return $author$project$Quiz$next(model);
			case 'Previous':
				return _Utils_Tuple2(
					$author$project$Quiz$previous(model),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Sommen$update = F2(
	function (message, model) {
		var _v0 = _Utils_Tuple2(message, model);
		if ((_v0.a.$ === 'QuizMessage') && (_v0.b.$ === 'Initialized')) {
			var msg = _v0.a.a;
			var quiz = _v0.b.a;
			var _v1 = A2($author$project$Quiz$update, msg, quiz);
			var nextQuiz = _v1.a;
			var cmd = _v1.b;
			return _Utils_Tuple2(
				$author$project$Sommen$Initialized(nextQuiz),
				A2($elm$core$Platform$Cmd$map, $author$project$Sommen$QuizMessage, cmd));
		} else {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
...
var $author$project$Quiz$DoNothing = {$: 'DoNothing'};
var $author$project$Quiz$Next = {$: 'Next'};
...
var $author$project$KeyEvent$onKey = F3(
	function (keyCode, messageOnKey, alternative) {
		var toMessage = function (n) {
			return _Utils_eq(n, keyCode) ? messageOnKey : alternative;
		};
		var decoder = A2($elm$json$Json$Decode$map, toMessage, $rtfeldman$elm_css$Html$Styled$Events$keyCode);
		return A2($rtfeldman$elm_css$Html$Styled$Events$on, 'keyup', decoder);
	});
var $author$project$KeyEvent$onPageDown = $author$project$KeyEvent$onKey(34);
...
var $author$project$Question$Checked = {$: 'Checked'};
var $author$project$Question$DoNothing = {$: 'DoNothing'};
var $author$project$Question$InputChanged = function (a) {
...
var $author$project$KeyEvent$onEnter = $author$project$KeyEvent$onKey(13);
...
var $author$project$Expression$operatorToString = function (op) {
	switch (op.$) {
		case 'Addition':
			return '+';
		case 'Subtraction':
...
var $author$project$Expression$viewOperator = function (op) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$span,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$class('operator')
			]),
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(
				$author$project$Expression$operatorToString(op))
			]));
};
var $author$project$Expression$viewIntegerValue = function (n) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$span,
		_List_fromArray(
			[
...
var $author$project$Expression$viewValue = function (n) {
	return $author$project$Expression$viewIntegerValue(n);
};
var $author$project$Expression$view = function (_v0) {
	var left = _v0.a;
	var op = _v0.b;
	var right = _v0.c;
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$class('expression'),
		...
		_List_fromArray(
			[
				$author$project$Expression$viewValue(left),
				$author$project$Expression$viewOperator(op),
				$author$project$Expression$viewValue(right)
			]));
};
var $author$project$Question$viewAnswer = function (data) {
...
var $author$project$Question$statusToString = function (aStatus) {
	switch (aStatus.$) {
		case 'UnChecked':
			return '?';
		case 'Correct':
...
var $author$project$Question$viewStatus = function (aStatus) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$span,
		_List_Nil,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(
				$author$project$Question$statusToString(aStatus))
			]));
};
var $author$project$Question$viewData = function (data) {
	var value = A2(
		$elm$core$Maybe$withDefault,
		data.answerInput,
		A2($elm$core$Maybe$map, $elm$core$String$fromInt, data.answer));
	var hasAnswer = A2(
		$elm$core$Maybe$withDefault,
		false,
		A2(
			...
			data.answer));
	var answerUnchecked = _Utils_eq(data.status, $author$project$Question$UnChecked);
	var disabled = (!hasAnswer) || (!answerUnchecked);
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Expression$view(data.expression),
				A2(
				$rtfeldman$elm_css$Html$Styled$span,
				_List_Nil,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Html$Styled$Attributes$size(4),
						$rtfeldman$elm_css$Html$Styled$Attributes$type_('input'),
						$rtfeldman$elm_css$Html$Styled$Attributes$value(value),
						$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Question$InputChanged),
						A2($author$project$KeyEvent$onEnter, $author$project$Question$Checked, $author$project$Question$DoNothing)
					]),
				_List_Nil),
				$author$project$Question$viewStatus(data.status),
				$author$project$Question$viewAnswer(data),
				A2(
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Question$Checked)
					]),
				_List_fromArray(
					[
...
var $author$project$Question$waitForIt = $rtfeldman$elm_css$Html$Styled$text('Wij zijn een som aan het maken');
var $author$project$Question$view = function (model) {
	if (model.$ === 'CreatingQuestion') {
		return $author$project$Question$waitForIt;
	} else {
		var data = model.a;
		return $author$project$Question$viewData(data);
	}
};
var $author$project$Quiz$viewNext = function (_v0) {
	var nextQuestions = _v0.nextQuestions;
	var _v1 = $elm$core$List$head(nextQuestions);
	if (_v1.$ === 'Just') {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Quiz$Next)
				]),
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('⏵')
...
var $author$project$Quiz$Previous = {$: 'Previous'};
var $author$project$Quiz$viewPrevious = function (_v0) {
	var previousQuestions = _v0.previousQuestions;
	var _v1 = $elm$core$List$head(previousQuestions);
	if (_v1.$ === 'Just') {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Quiz$Previous)
				]),
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('⏴')
...
var $author$project$Question$summaryContent = function (aStatus) {
	var content = $author$project$Question$statusToString(aStatus);
	var c = function () {
		switch (aStatus.$) {
			case 'UnChecked':
				return A3($rtfeldman$elm_css$Css$rgb, 192, 192, 192);
			case 'Correct':
				return A3($rtfeldman$elm_css$Css$rgb, 0, 255, 0);
			default:
				return A3($rtfeldman$elm_css$Css$rgb, 255, 0, 0);
		}
	}();
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
			...
			[
				...
				_List_fromArray(
					[
						...
						A3($rtfeldman$elm_css$Css$rgb, 0, 0, 0)),
						$rtfeldman$elm_css$Css$backgroundColor(c),
...
var $author$project$Question$defaultSummary = $author$project$Question$summaryContent($author$project$Question$UnChecked);
...
var $author$project$Question$status = function (model) {
	if (model.$ === 'CreatingQuestion') {
		return $author$project$Question$UnChecked;
	} else {
		var data = model.a;
		return data.status;
	}
};
var $author$project$Question$summary = function (model) {
	return $author$project$Question$summaryContent(
		$author$project$Question$status(model));
};
...
var $author$project$Quiz$viewSummary = function (data) {
	var toSummary = function (candidate) {
		return A2(
			$elm$core$Maybe$withDefault,
			$author$project$Question$defaultSummary,
			A2($elm$core$Maybe$map, $author$project$Question$summary, candidate));
	};
	var content = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$class('previous'),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$displayFlex,
			...
			A2($elm$core$List$map, $author$project$Question$summary, data.previousQuestions)),
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Css$scale(1.2))
						]))
				]),
			_List_fromArray(
				[
					$author$project$Question$summary(data.currentQuestion)
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$class('next'),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$displayFlex,
			...
			A2($elm$core$List$map, toSummary, data.nextQuestions))
		]);
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$class('summary'),
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$displayFlex,
...
var $author$project$Quiz$view = function (_v0) {
	var data = _v0.a;
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$class('quiz'),
				A2($author$project$KeyEvent$onPageDown, $author$project$Quiz$Next, $author$project$Quiz$DoNothing)
			]),
		_List_fromArray(
			[
				$author$project$Quiz$viewSummary(data),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('quiz', true),
								_Utils_Tuple2('current', true)
							])),
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$author$project$Quiz$viewPrevious(data),
						A2(
						$rtfeldman$elm_css$Html$Styled$map,
						$author$project$Quiz$QuestionMessage,
						$author$project$Question$view(data.currentQuestion)),
						$author$project$Quiz$viewNext(data)
					]))
			]));
};
...
var $author$project$Sommen$main = $elm$browser$Browser$application(
	{
		init: $author$project$Sommen$init,
		onUrlChange: function (_v0) {
			return $author$project$Sommen$DoNothing;
		},
		onUrlRequest: function (_v1) {
			return $author$project$Sommen$DoNothing;
		},
		subscriptions: $author$project$Sommen$subscriptions,
		update: $author$project$Sommen$update,
		view: $author$project$Sommen$view
	});
_Platform_export({'Sommen':{'init':$author$project$Sommen$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Sommen.Message","aliases":{},"unions":{"Sommen.Message":{"args":[],"tags":{"QuizMessage":["Quiz.Message"],"DoNothing":[]}},"Quiz.Message":{"args":[],"tags":{"QuestionMessage":["Question.Message"],"Next":[],"Previous":[],"DoNothing":[]}},"Question.Message":{"args":[],"tags":{"ExpressionReceived":["Expression.Expression"],"InputChanged":["String.String"],"Checked":[],"DoNothing":[]}},"Expression.Expression":{"args":[],"tags":{"Expression":["Basics.Int","Expression.Operator","Basics.Int"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Expression.Operator":{"args":[],"tags":{"Addition":[],"Subtraction":[],"Multiplication":[]}}}}})}});}(this));